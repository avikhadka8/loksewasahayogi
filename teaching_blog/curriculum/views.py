...
# def search(request):
#     return(request,'curriculum/search.html',{})

def searchView(request):
    if request.method == "POST":
        searched = request.POST.get('searched')
        result = Lesson.objects.all().filter(name__contains=searched)
        return render(request,'curriculum/search.html',{"searched":searched,'result':result})
    else:
        return render(request,'curriculum/search.html',{searched})