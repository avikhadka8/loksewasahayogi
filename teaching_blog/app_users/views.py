...
#         result = UserProfileInfo.objects.filter(user__contains=searched)
#         return render(request,'app_users/search.html',{"searched":searched,'result':result})
#     else:
#         return render(request,'app_users/search.html',{search})
